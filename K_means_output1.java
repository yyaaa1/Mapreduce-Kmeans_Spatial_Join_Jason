    ...
    public class K_means_output1 {
        ...
        public static class map2
            ...
            public void map(Object key, Text value, Context context)
                    throws IOException, InterruptedException {
                Text con = new Text();
                Text point_out = new Text();
                String Convergence = "Converged";
                con.set(Convergence);
                String[] list_1 = value.toString().split(",");
                point_out.set(list_1[0]+","+list_1[1]+","+list_1[2]);
                context.write(point_out,con);
            }
        ...
        public static class Reducer1
            ...
            public void reduce(Text key, Iterable<Text> values,
                ...
                centroid_out.set(key.toString()+","+updated_centroid+","+"Not Converged");
        ...
        public static void main(String[] args) throws Exception {
            ...
            for(int i = 0; i < Integer.parseInt(args[1]); i++){
                ...
                job.setJarByClass(K_means_output1.class);
                ...
                if(check_difference.check(new Path(filename), new Path(args[3]+i+"result.txt"),fs)){
                    ...
                    job2.setJarByClass(K_means_output1.class);
                    job2.setMapperClass(map2.class);
                    job2.setNumReduceTasks(0);
                    job2.setOutputKeyClass(Text.class);
                    job2.setOutputValueClass(Text.class);
                    FileInputFormat.addInputPath(job2, new Path(filename));
