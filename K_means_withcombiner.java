...
public class K_means_withcombiner {
    ...
    public static class Combiner
        ...
        public void reduce(Text key, Iterable<Text> values,
            ...
            Text local_centroid_out = new Text();
            double X_sum = 0.0;
            double Y_sum = 0.0;
            int a = 0;
            for (Text v : values) {
            ...
            System.out.println("combiner "+X_sum+","+Y_sum+","+a);
    ...
    public static class Reducer1
        ...
        public void reduce(Text key, Iterable<Text> values,
            ...
            System.out.println("reducer "+X_sum/a+","+Y_sum/a+","+a);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filename = "hdfs://localhost:9000/input/yyang19.txt";
        ...
        for(int i = 0; i < Integer.parseInt(args[1]); i++){
            ...
            job.setJarByClass(K_means_withcombiner.class);
